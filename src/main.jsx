...
ReactDOM.createRoot(document.getElementById('root')).render(
      ...
      <ThirdwebSDKProvider activeChain={ShardeumSphinxDapp1X}   clientId={import.meta.env.VITE_CLIENT_ID}  signer={new ethers.providers.Web3Provider(window.ethereum).getSigner()}>
  <ThirdwebProvider 
