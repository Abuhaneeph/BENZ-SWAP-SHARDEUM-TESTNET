...
import "./index.css"
import { ShardeumSphinxDapp1X,ZetachainAthens3Testnet } from "@thirdweb-dev/chains";
...
ReactDOM.createRoot(document.getElementById('root')).render(
      ...
      <ThirdwebSDKProvider   clientId={import.meta.env.VITE_CLIENT_ID} signer={isMetaMaskInstalled ? new ethers.providers.Web3Provider(window.ethereum).getSigner() : null}>
  <ThirdwebProvider 
